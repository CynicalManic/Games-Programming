...
HRESULT Application::InitDevice()
{
	...
	// used for depth/stencil buffer
	// 24 bits for depth, 7 for stencil
...
void Application::Update()
{
	...
	XMStoreFloat4x4(&_world2, XMMatrixRotationX(t) * XMMatrixTranslation(3.0f, 0.0f, 0.0f) * XMMatrixRotationZ(t));
}
